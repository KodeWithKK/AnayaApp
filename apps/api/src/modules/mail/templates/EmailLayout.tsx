...
export const EmailLayout = ({ children, previewText }: EmailLayoutProps) => {
  return (
    <Html>
      ...
      <Tailwind>
        <Body className="bg-[#f8f9fa] py-12 font-sans">
          <Container className="mx-auto max-w-[580px] rounded-2xl bg-white p-10 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            <Section className="mb-8 text-center">
              <Text className="m-0 text-3xl font-extrabold tracking-tighter text-black">
                ANAYA
              </Text>
            ...
            <Section className="text-center">
              <Text className="mb-2 text-sm font-bold tracking-widest text-gray-600 uppercase">
                Anaya Global
              </Text>
              <Text className="text-sm leading-relaxed tracking-wider text-gray-400 uppercase">
          ...
          <Section className="mx-auto mt-8 max-w-[580px] px-4 text-center">
            <Text className="m-0 text-sm tracking-widest text-gray-400 uppercase no-underline">
