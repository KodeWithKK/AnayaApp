...
const VerticalContent = () => {
  return (
    <View className="flex-1 items-center justify-center px-8">
      <View className="h-48 flex-row items-center justify-center gap-12">
    ...
    <View className="flex-1 items-center justify-center px-8">
      <View className="w-full gap-8">
        ...
        <Slider defaultValue={65}>
          ...
          <Slider.Track className="bg-success/10 h-3 rounded-full">
            <Slider.Fill
        ...
        <Slider defaultValue={40}>
          ...
          <Slider.Track className="bg-warning/15 h-1 rounded-full">
        ...
        <Slider defaultValue={70}>
          ...
          <Slider.Track className="bg-default/40 h-7 rounded-2xl">
            <Slider.Fill
      ...
      <View className="flex-1 items-center justify-center">
        <BottomSheet isOpen={isOpen} onOpenChange={setIsOpen}>
          ...
          <BottomSheet.Portal>
            <BottomSheet.Overlay />
            <BottomSheet.Content>
              <BottomSheet.Title className="mb-4 text-xl font-semibold">
                Audio settings
              </BottomSheet.Title>
