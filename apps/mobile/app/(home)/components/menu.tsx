              ...
              <Menu.Content presentation="popover" width={250}>
                ...
                <Menu.Group
                  ...
                  <Menu.Item id="bold">
                    ...
                    <AppText className="text-muted text-sm">⌘ B</AppText>
                  </Menu.Item>
                  <Menu.Item id="italic">
                    <Menu.ItemIndicator />
                    <Menu.ItemTitle>Italic</Menu.ItemTitle>
                    <AppText className="text-muted text-sm">⌘ I</AppText>
                  </Menu.Item>
                  <Menu.Item id="underline">
                    <Menu.ItemIndicator />
                    <Menu.ItemTitle>Underline</Menu.ItemTitle>
                    <AppText className="text-muted text-sm">⌘ U</AppText>
                  </Menu.Item>
                </Menu.Group>
                ...
                <Menu.Group
                  ...
                  <Menu.Item id="left">
                    ...
                    <AppText className="text-muted text-sm">⌥ A</AppText>
                  </Menu.Item>
                  <Menu.Item id="center">
                    <Menu.ItemIndicator variant="dot" />
                    <Menu.ItemTitle>Center</Menu.ItemTitle>
                    <AppText className="text-muted text-sm">⌥ H</AppText>
                  </Menu.Item>
                  <Menu.Item id="right">
                    <Menu.ItemIndicator variant="dot" />
                    <Menu.ItemTitle>Right</Menu.ItemTitle>
                    <AppText className="text-muted text-sm">⌥ D</AppText>
                  </Menu.Item>
                </Menu.Group>
              </Menu.Content>
            </Menu.Portal>
            ...
            <Menu.Content presentation="popover" width={240}>
              ...
              <SubMenu>
                <SubMenu.Trigger textValue="Focus">
                  ...
                  <AppText className="text-foreground flex-1 text-base font-medium">
                    Focus
                  </AppText>
                </SubMenu.Trigger>
                <SubMenu.Content>
