  ...
  return (
    <View className="flex-1 items-center justify-center px-5">
      ...
      <View className="flex-row">
        ...
        <Avatar className="border-background -ml-4 border-2" alt="More">
    ...
    <View className="flex-1 items-center justify-center px-5">
      <View className="flex-row items-center justify-center gap-4">
        ...
        <Avatar className="p-[2.5px]" size="lg" alt="Gradient Border">
          ...
          />
          <Avatar.Image
            className="border-background rounded-full border-[0.5px]"
            source={{
        ...
        <View className="relative">
          ...
          <View className="border-background absolute right-0.5 bottom-0.5 size-3.5 rounded-full border bg-green-500" />
        </View>
      </View>
    </View>
  );
