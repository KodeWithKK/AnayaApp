      ...
      <View className="gap-8">
        ...
        <View className="flex-row flex-wrap justify-center gap-4">
          <Chip size="md" variant="secondary">
            <View className="bg-accent mr-1.5 size-1.5 rounded-full" />
            <Chip.Label>Information</Chip.Label>
          </Chip>
          <Chip size="md" variant="secondary" color="success">
            <View className="bg-success mr-1.5 size-1.5 rounded-full" />
            <Chip.Label>Completed</Chip.Label>
          </Chip>
          <Chip size="md" variant="secondary" color="warning">
            <View className="bg-warning mr-1.5 size-1.5 rounded-full" />
            <Chip.Label>Pending</Chip.Label>
          </Chip>
          <Chip size="md" variant="secondary" color="danger">
            <View className="bg-danger mr-1.5 size-1.5 rounded-full" />
    ...
    <View className="flex-1 items-center justify-center px-5">
      <View className="flex-row flex-wrap justify-center gap-4">
        ...
        <Chip
          ...
          <View className="bg-muted/20 rounded-full p-1">
            <XMarkIcon size={12} colorClassName="accent-muted" />
          </View>
        </Chip>
      </View>
