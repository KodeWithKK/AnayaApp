  ...
  return (
    <View className="flex-1 items-center justify-center px-5">
      <View>
        ...
        <Description className="mb-2.5 px-1">
  ...
  return (
    <View className="flex-1 items-center justify-center px-5">
      <InputOTP
        ...
        placeholder="——————"
        onComplete={onComplete}
        className="bg-surface shadow-surface w-full items-center justify-center gap-8 rounded-3xl py-4"
        style={{
            ...
            <>
              {slots.slice(0, 3).map((slot) => (
                <InputOTP.Slot
                  ...
                  index={slot.index}
                  className={cn(
                    "w-8 bg-transparent shadow-none",
