        ...
        <Dialog isOpen={basicDialogOpen} onOpenChange={setBasicDialogOpen}>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content>
              ...
              />
              <View className="bg-overlay-foreground/5 mb-4 size-9 items-center justify-center rounded-full">
        ...
        <Dialog isOpen={scrollDialogOpen} onOpenChange={setScrollDialogOpen}>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content className="rounded-2xl px-0">
              <Dialog.Close variant="ghost" className="mr-4 self-end" />
  ...
  return (
    <View className="flex-1">
      <View className="flex-1 items-center justify-center">
        <Button
          variant="secondary"
          onPress={() => router.push("/(home)/components/dialog-native-modal")}>
          <Button.Label maxFontSizeMultiplier={1.6}>
