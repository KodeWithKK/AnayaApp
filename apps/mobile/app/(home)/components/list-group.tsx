...
const BasicContent = () => {
  ...
  return (
    <View className="flex-1 justify-center px-5">
      <AppText className="text-muted mb-2 ml-2 text-sm">Account</AppText>
      ...
      <AppText className="text-muted mb-2 ml-2 text-sm">Preferences</AppText>
      <ListGroup>
        <ListGroup.Item>
          <ListGroup.ItemPrefix>
      ...
      <View className="w-full">
        <ListGroup>
          ...
          <ListGroup.Item>
            ...
            <ListGroup.ItemSuffix>
              <AppText className="text-muted text-sm">Select</AppText>
            </ListGroup.ItemSuffix>
          </ListGroup.Item>
          <Separator className="mx-4" />
          <ListGroup.Item>
