  ...
  return (
    <View className="flex-1 items-center justify-center gap-6 px-5">
      <View className="gap-2">
        <AppText className="text-muted text-sm">Default</AppText>
      ...
      <View className="gap-2">
        <AppText className="text-muted text-sm">Surface</AppText>
...
const SizesContent = () => {
  return (
    <View className="flex-1 items-center justify-center gap-6 px-5">
      <View className="gap-2">
        <AppText className="text-muted text-center text-sm">sm</AppText>
      ...
      <View className="gap-2">
        <AppText className="text-muted text-center text-sm">md</AppText>
      ...
      <View className="gap-2">
        <AppText className="text-muted text-center text-sm">lg</AppText>
...
const DisabledContent = () => {
  return (
    <View className="flex-1 items-center justify-center gap-6 px-5">
      <View className="gap-2">
        <AppText className="text-muted text-sm">Individual disabled</AppText>
      ...
      <View className="gap-2">
        <AppText className="text-muted text-sm">Disabled keys</AppText>
        <TagGroup
          selectionMode="single"
  ...
  return (
    <View className="flex-1 justify-center gap-8 px-5">
      <TagGroup selectionMode="single" onRemove={onRemoveTags}>
        ...
        <TagGroup.List
          renderEmptyState={() => (
            <AppText className="text-muted p-1 text-sm">
              No categories found
            </AppText>
          )}>
          {tags.map((tag) => (
