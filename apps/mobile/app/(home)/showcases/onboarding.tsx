  ...
  return (
    <View
      ...
      <AnimatedView
        ...
        <AppText className="text-muted text-xs font-semibold tracking-wider uppercase">
          Lesson 1
        </AppText>
        <AppText className="text-foreground text-3xl font-semibold">
          Setting Up a Show
        </AppText>
        <AppText className="text-foreground/75 text-center text-base">
          It&apos;s fast and simple, and we&apos;ve got a few pointers to help
