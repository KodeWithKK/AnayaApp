  ...
  return (
    <View
      ...
      <Animated.View entering={FadeIn.duration(1000)}>
        <View>
          <Pressable
            className="top0 absolute left-0 z-50"
            onPress={router.back}
            hitSlop={16}>
            <StyledFeather
              name="chevron-left"
        ...
        <AppText className="text-default mt-3 text-center text-sm font-medium tracking-wider uppercase">
      ...
      <AnimatedView
        ...
        <RadioGroup
          ...
          <View>
            <Chip
              size="sm"
              className="absolute -top-2.5 right-6 z-50 bg-rose-600">
              <Chip.Label className="font-medium text-white uppercase">
                Best offer
              </Chip.Label>
            </Chip>
            <StyledRadio
