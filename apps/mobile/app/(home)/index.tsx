...
const HomeCard: FC<HomeCardProps & { index: number }> = ({
  ...
  return (
    <AnimatedPressable
      ...
      onPress={() => router.push(`/(home)/${path}` as Href)}>
      <Card
        className={cn(
          "border border-zinc-200 p-0 shadow-none",
        ...
        <View className="gap-4">
          ...
          <Card.Footer className="flex-row items-end gap-4 px-3 pb-3">
            <View className="flex-1">
              <Card.Title
                className="text-foreground/85 text-2xl"
            ...
            <View className="bg-background/25 size-9 items-center justify-center rounded-3xl">
              <StyledFeather
                name="arrow-up-right"
                size={20}
