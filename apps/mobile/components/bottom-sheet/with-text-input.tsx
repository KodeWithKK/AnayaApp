...
const UserSearchItem = ({ user }: { user: User }) => {
  ...
  return (
    <View className="mb-2 flex-row items-center py-2.5">
        ...
        <BottomSheetScrollView
          ...
          {filteredUsers.length > 0 ? (
            ...
            <View className="items-center justify-center py-8">
              ...
              />
              <AppText className="text-muted text-base">No users found</AppText>
              <AppText className="text-muted mt-1 text-sm">
