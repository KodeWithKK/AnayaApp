    ...
    return (
      <View className="items-center gap-6">
        <Avatar size="lg" color="accent" variant="soft" alt="Verification icon">
          <Avatar.Fallback>
            <AppText className="text-foreground text-2xl font-semibold">
              ✓
            </AppText>
          </Avatar.Fallback>
        </Avatar>
        ...
        <View className="items-center gap-1 px-2">
          ...
          <Description className="text-muted text-center text-base">
            We sent a verification code to
          </Description>
          <AppText className="text-foreground mt-1 text-center text-base font-semibold">
...
BottomSheetInputOTP.displayName = "BottomSheetInputOTP";
    ...
    <BottomSheet.Content
      ...
      <BottomSheetScrollView
        ...
        <View className="mt-8 px-2">
          <AppText className="text-muted text-center text-xs leading-5">
