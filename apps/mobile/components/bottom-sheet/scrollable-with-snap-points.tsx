  ...
  const renderFooter = useCallback(
    (props: { animatedFooterPosition: any }) => (
      <BottomSheetFooter {...props}>
        <View className="pb-safe-offset-3 bg-overlay px-4">
        ...
        <BottomSheet isOpen={isOpen} onOpenChange={setIsOpen}>
          ...
          <BottomSheet.Portal>
            ...
            <BottomSheet.Content
              ...
              <View className="flex-row items-center justify-between gap-4 pr-5 pb-3 pl-7">
                <BottomSheet.Title
              ...
              <BottomSheetScrollView
                ...
                <View className="mb-4 px-3">
                  {taxiOptions.map((option) => (
                    <Card
                      key={option.id}
                      className={cn(
                        "mb-2 flex-row items-center shadow-none",
                        !option.highlight
                          ? "bg-transparent"
                          : isDark
                            ? "bg-green-900/40"
                      ...
                      <Card.Body className="flex-1">
                        ...
                        {option.description && (
                          <Card.Description className="text-success mt-1 text-xs">
                            {option.description}
                          </Card.Description>
                        )}
                      </Card.Body>
                ...
                <View className="px-3">
                  <Card
                    ...
                    <View className="mr-3 size-8 items-center justify-center rounded-full bg-yellow-400">
                  ...
                  <Card
                    ...
                    <View className="mr-3 size-10 items-center justify-center rounded-lg bg-red-500">
                      <StyledIonicons
                        name="person"
                        size={20}
                        className="text-white"
                  ...
                  <View className="mb-6 px-4">
                    <BottomSheet.Title className="mb-3 font-semibold">
                      Trip Details
                    </BottomSheet.Title>
                    <BottomSheet.Description className="mb-2 text-sm">
