  ...
  return (
    <View className="flex-row items-center justify-between py-3">
      <View className="flex-1 flex-col">
        <AppText className="text-foreground text-base">{name}</AppText>
        <AppText className="text-muted text-sm">{description}</AppText>
      </View>
...
export const Ingridients: FC = () => {
  return (
    <View className="mt-5">
      <AppText className="text-foreground mb-3 text-xl font-semibold">
        Ingredients
      </AppText>
      <View>
