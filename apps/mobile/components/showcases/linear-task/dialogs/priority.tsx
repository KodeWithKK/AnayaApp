  ...
  return (
    <RadioGroup.Item
      ...
      <View className="flex-row items-center gap-2">
        <View className="w-7 justify-center pl-0.5">
          <View className="scale-105">{item.indicator}</View>
        </View>
        <Label>{item.label}</Label>
      </View>
      <Radio>
        <Radio.Indicator className="border-none bg-transparent shadow-none">
          {value === item.value && (
  ...
  const items: PriorityItem[] = [
    {
      ...
      indicator: (
        <View className="flex-row items-center gap-0.5">
          <View className="bg-muted/50 h-[1.5px] w-1" />
          <View className="bg-muted/50 h-[1.5px] w-1" />
          <View className="bg-muted/50 h-[1.5px] w-1" />
        </View>
      ),
    ...
    },
    {
      ...
      indicator: (
        <View className="flex-row items-end gap-0.5">
          <View className="bg-foreground h-1 w-[3px] rounded-[1px]" />
          <View className="bg-foreground h-2 w-[3px] rounded-[1px]" />
          <View className="bg-foreground h-3 w-[3px] rounded-[1px]" />
        </View>
      ),
    },
    {
      ...
      indicator: (
        <View className="flex-row items-end gap-0.5">
          <View className="bg-foreground h-1 w-[3px] rounded-[1px]" />
          <View className="bg-foreground h-2 w-[3px] rounded-[1px]" />
          <View className="bg-muted/50 h-3 w-[3px] rounded-[1px]" />
        </View>
      ),
    },
    {
      ...
      indicator: (
        <View className="flex-row items-end gap-0.5">
          <View className="bg-foreground h-1 w-[3px] rounded-[1px]" />
          <View className="bg-muted/50 h-2 w-[3px] rounded-[1px]" />
          <View className="bg-muted/50 h-3 w-[3px] rounded-[1px]" />
        </View>
      ),
    },
